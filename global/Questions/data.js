const data = [
    {
      ...
      qnA: [
        ...
        },
        {
            ...
            options: ["Quietly be disgruntled by the Nduthi guy's lack of road safety and etiquette", "Let the road rage burn. Chase him, Open your window and shout at him"],
            tip: "In Kenya, negligence accounted for the highest number of reported crashes at 33%"
        },
        {
        ...
        },
        {
            ...
            options: ["Continue with that juicy story", "Hang up and call when you cross the road"],
        ...
        },
        {
            ...
            options: ["Begrugingly take that helmet and hope that you can restore your hair to its glory once you remove the helmet", "Geez! First of all that helmet stinks, secondly I don't know how many people have been in it. Thirdly, I didn't spend all that money to make my hair to mess my look with a helmet so no thank you I will pass on the helmet"],
